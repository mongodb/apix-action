...
pub async fn create(
    ...
    for repository in repositories {
        ...
        info!(repository = %format_args!("{}/{}", repository.owner, repository.repository), pull_request = pull_request.number, "pull request created");
    }
...
async fn close_labeled_pull_requests(github: &Octocrab, repository: &Repo) -> Result<()> {
    ...
    for pull_request in pulls {
        ...
        info!(repository = %format_args!("{}/{}", repository.owner, repository.repository), pull_request = pull_request.number, "pull request closed");
    }
